...
const Contact = () => {
  return (
    <div name='contact' className='w-full h-screen bg-[#454646] flex flex-col justify-center items-center p-6' style={{ backgroundImage: `url(${background})`, backgroundSize: 'cover' }}>
      {/* Upper Section */}
