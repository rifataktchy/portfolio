...
<div name='home' className= 'w-full h-screen bg-[#454646]' style={{ backgroundImage: `url(${background})`, backgroundSize: 'cover' }}>
        ...
        <h1 className='text-1xl sm:text-4xl font-bold text-[#ccd6f6]'>
          Rifhat Akther Chowdhury
        </h1>
        <h1 className='text-2xl sm:text-5xl font-bold text-[#8fa7ee] hover:ml-[-20px] duration-300'>
          Front end Developer.
        </h1>
          ...
          designing exceptional digital experiences.</p>
                  </div>
