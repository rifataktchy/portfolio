  ...
  return (
    <div name='work' className='w-full h-full bg-[#6e6f6f] text-gray-300'>
       <div className='max-w-[1000px] mx-auto p-20 flex flex-col justify-center w-full h-full'>
          ...
          <div style={{ backgroundImage: `url(${work6})`, backgroundSize: 'cover' }} className='h-[180px] shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto contect-div'>
          ...
          <div style={{ backgroundImage: `url(${work1})`, backgroundSize: 'cover' }} className='h-[180px] shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto contect-div'>
              <div className='opacity-0 group-hover:opacity-100 pl-8 pt-3'> 
                <span className='text-2xl font-bold text-pwhite tracking-wider'>
